...
void animationTest()
{
	...
	Animation *testAnim = new Vec2Lerp(&testRef, Vec2(1.0f, 0.0f), Vec2(2.0f, 1.0f), 5.0f);
	Animation *testAnim2 = new Vec2Lerp(&testRef, Vec2(2.0f, 1.0f), Vec2(0.0f, 1.0f), 5.0f, testAnim);
